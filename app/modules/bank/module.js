...
(function(){
  ...
  var MESSAGES={
    ...
    de:{ bank:{
      title:"Kasse", subtitle:"Deine Punkte fuer Spiele und Aufgaben",
      ptsWord:"Punkte", streakLabel:"Siegesserie",
      tabTasks:"Aufgaben", tabLog:"Verlauf",
      emptyLog:"Noch keine Punkte — spiele Spiele und erledige Aufgaben!",
      subParent:"Punkte und Aufgaben verwalten",
      mgrAdd:"+ Punkte geben", mgrFine:"⚠️ Strafe",
      assignments:"Aufgaben", assignmentsN:"Aufgaben · {n} warten", backHistory:"Verlauf",
      giveTitle:"Punkte geben", penTitle:"Strafe",
      txCount:{one:"{n} Eintrag",other:"{n} Eintraege"},
      fltAll:"Alle", fltTasks:"Aufgaben", fltGames:"Spiele", fltApps:"Apps", fltParents:"Eltern", fltShop:"Shop", moreLog:"Mehr anzeigen",
      hudPts:"Punkte", hudStreak:"Serie",
      loadFail:"Kasse konnte nicht geladen werden", retry:"Nochmal versuchen",
      r_teeth:"Zaehneputzen", r_teeth_manual:"Eltern-Korrektur",
      r_guess_win:"Zahl erraten — gewonnen", r_guess_wrong:"Zahl erraten — falsch",
      r_guess_timeout:"Zahl erraten — Zeit vorbei",
      r_streak_bonus:"Serienbonus 🔥", r_parent_give:"Von Eltern", r_parent_take:"Von Eltern abgezogen",
      r_parent_penalty:"Strafe",
      r_task_done:"Elternaufgabe erledigt", r_task_fail:"Aufgabe nicht erledigt", r_daily_bonus:"Alle Tagesaufgaben!",
      r_spend:"Shop", r_spend_refund:"Shop — Punkte zurueck", r_other:"Punkte",
      earnedAll:"insgesamt verdient: {n}",
      parentTitle:"Elternbereich", parentOnly:"Nur fuer angemeldete Eltern.",
      balanceNow:"in der Kasse", streakNow:"Siegesserie",
      secBonus:"Bonus", btnDailyBonus:"★ Alle Aufgaben heute +5",
      infoTitle:"Was ist das Feuer? 🔥",
      infoIntro:"Das Feuer ist deine Serie von Tagen mit Elternaufgaben.",
      infoRule1:"Erledige mindestens eine Elternaufgabe an einem Tag — das Feuer brennt und die Zahl waechst: +1 fuer jeden Tag in Folge.",
      infoRule2:"Einen ganzen Tag ohne Aufgaben auslassen — das Feuer geht aus und startet wieder bei 0.",
      infoRule3:"Je groesser das Feuer, desto groesser das Geschenk: Jede erledigte Aufgabe bringt den Bonus “Feuer − 1” als Extrapunkte.",
      infoExTitle:"Beispielwoche",
      infoEx1:"Mo — Aufgabe erledigt → Feuer 1, noch kein Bonus",
      infoEx2:"Di — Aufgabe erledigt → Feuer 2, Bonus +1",
      infoEx3:"Mi — Aufgabe erledigt → Feuer 3, Bonus +2",
      infoEx4:"Do — gar keine Aufgaben → Feuer aus, 0",
      infoEx5:"Fr — Aufgabe erledigt → Feuer wieder 1",
      infoMax:"Das groesste Feuer ist 21 — dann gibt jede Aufgabe +20 Bonuspunkte!",
      infoGames:"Spiele geben auch Punkte, aber nur Elternaufgaben entzuenden das Feuer.",
      plusLabel:"Punkteserie",
      pinfoTitle:"Was ist die Punkteserie? ⚡",
      pinfoIntro:"Die Punkteserie zaehlt deine Pluspunkte in Folge, ohne ein einziges Minus.",
      pinfoRule1:"Jede gruene Plus-Zeile (Sieg, Aufgabe, Bonus) erhoeht die Serie um 1.",
      pinfoRule2:"Bekommst du ein Minus (Spiel verloren oder Punkte abgezogen), faellt die Serie auf 0.",
      pinfoRule3:"Das naechste Plus startet wieder: 1, 2, 3…",
      pinfoExTitle:"Beispiel",
      pinfoEx1:"+10 Zaehneputzen → Serie 1",
      pinfoEx2:"+10 Elternaufgabe → Serie 2",
      pinfoEx3:"+1 Serienbonus → Serie 3",
      pinfoEx4:"−5 falsch geraten → Serie aus, 0",
      pinfoEx5:"+10 Aufgabe → Serie wieder 1",
      pinfoNote:"Kein Limit — schau, wie lange du sie halten kannst!",
      pinfoVs:"Das Feuer 🔥 zaehlt Tage mit Aufgaben. Die Punkteserie ⚡ zaehlt Pluspunkte in Folge. Beides ist getrennt.",
      secCustom:"Eigener Betrag", amountPh:"Wie viele", notePh:"Wofuer (das Kind sieht es)",
      btnGive:"Geben", btnPen:"⚠️ Strafe", needAmount:"Gib zuerst eine Zahl ein",
      needNote:"Schreib, wofuer die Strafe ist", doneToast:"Fertig!",
      streakToast:"Siegesserie: {n} 🔥", bonusToast:"Serienbonus +{n}!",
      btnAddTask:"+ Neue Aufgabe", btnPropose:"+ Aufgabe melden", btnIDid:"Erledigt!", btnReview:"Pruefen",
      secReview:"Wartet auf Pruefung", secActive:"Aktiv & wiederkehrend", secTodo:"Zu erledigen",
      secWaiting:"Wartet auf Pruefung", secDone:"Erledigt",
      chipPending:"wartet auf Pruefung ⏳", chipDone:"erledigt ✓",
      chipProposed:"vorgeschlagen +{n}", propTag:"Idee des Kindes", tagProposal:"meine Idee", denyA11y:"Vorschlag ablehnen",
      typeRecur:"Wiederholend", typeOnce:"Einmalig",
      metaRecur:"🔁 wiederholt", metaOnce:"1× einmalig", doneTimes:"erledigt ×{n}", doneOn:"erledigt {d}",
      approveBtn:"✓ +{n}", declineA11y:"Ohne Punkte zurueckgeben",
      claimToast:"An Eltern zur Pruefung gesendet!", returnedToast:"Ohne Punkte zurueckgegeben",
      deniedToast:"Vorschlag abgelehnt", proposedToast:"An deine Eltern gesendet!",
      proposeTitle:"Erledigte Aufgabe melden", proposeTitlePh:"Was hast du erledigt?",
      proposePtsLbl:"Wie viele Punkte, meinst du?", proposeHint:"Ein Elternteil prueft es und entscheidet.", proposeSend:"Vorschlagen",
      reviewTitle:"Vorschlag pruefen", reviewPtsLbl:"Punkte dafuer", approveAdj:"Bestaetigen +{n}", denyBtn:"Ablehnen",
      emptyKid:"Noch keine Aufgaben — frag deine Eltern oder melde eine erledigte Aufgabe!", emptyParent:"Noch keine Aufgaben. Erstelle die erste!",
      newTask:"Neue Aufgabe", editTask:"Aufgabe bearbeiten",
      taskTitlePh:"Was muss erledigt werden", taskPtsLbl:"Punkte fuer Erledigung",
      deleteTask:"Aufgabe loeschen", confirmDel:"Aufgabe “{t}” loeschen?",
      needTitle:"Schreib zuerst den Namen"
    }}
  };

...
(function(RT){
  ...
  /* =================== данные =================== */
  /* silent=true — ТИХАЯ дозагрузка (живое обновление, v2026.06.07.55): старый контент
  ...
  RT.Parent={
    /* показать дашборд (вызывает shell.showParent после переключения вида).
       Кэш рисуем МГНОВЕННО и всегда дотягиваем свежее тихой дозагрузкой (v2026.06.07.55):

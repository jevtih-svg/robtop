...
(function(RT){
  ...
  de:{ parent:{
    badge:"Nur Ansicht", lastSeen:"letzte Aktivitaet: {x}", never:"noch keine Aktivitaet",
    refresh:"Aktualisieren", switchChild:"Kind waehlen", close:"Schliessen",
    noChild:{ h:"Noch keine Kinder", p:"Fuege ein Kind in Einstellungen → Familie hinzu — Wunschliste, Statistiken und Aktivitaet erscheinen hier.", btn:"Einstellungen oeffnen"},
    loadFail:"Daten konnten nicht geladen werden", retry:"Erneut versuchen",
    nav:{ apps:"Apps", bank:"Kasse", chat:"Chat" },
    areaSect:{ stat:"Statistik", content:"Eintraege des Kindes", recent:"Aktuell" },
    st:{ streak:"Serie", period:"gesamt", avg:"Durchschnitt", rated:"bewertet", often:"am haeufigsten", recs:"Eintraege",
      want:"will ich", thinking:"ueberlege", bought:"gekauft", walks:"Spaziergaenge", points:"Punkte" },
    openApp:"App oeffnen", points:"Punkte gesamt",
    sum:{ wishlist:"{want} will · {bought} gekauft",
      teeth:"Serie {n} 🔥", rating:"Ø {avg}★", mood:"meist {e}", reverse:"{c} Woerter", guess:"{w} von {c}",
      walk:"{c} Spaziergaenge", names:"lustige Namen", snake:"Snake", bank:"{p} Pkt · {s} 🔥",
      tasks:"⏳ {n} warten", tasksNone:"{n} aktiv", shop:"🛍 {n} zu bestaetigen", shopNone:"{n} Preise",
      chat:"Chat oeffnen", seabattle:"{w} von {c} gewonnen", none:"oeffnen" },
    m:{ lastEvents:"Letzte Ereignisse", empty:"Noch nichts hier.",
      noText:"kein Kommentar", liked:"Gefallen: {x}", walkAdd:"🐾 Spaziergang eintragen" },
    give:{ btn:"⭐ Punkte geben", title:"Punkte geben", customPh:"Wie viele", notePh:"Wofuer? (das Kind sieht es)",
      submit:"Geben +{n}", needAmount:"Betrag eingeben", needNote:"Schreib, wofuer",
      done:"+{n} Punkte hinzugefuegt", fail:"Konnte nicht gespeichert werden, versuch es nochmal" },
    pen:{ btn:"⚠️ Strafe", title:"Strafe", submit:"−{n} abziehen", done:"−{n} Punkte abgezogen" },
    g:{ win:"erraten", wrong:"falsch", timeout:"Zeit vorbei" },
    wl:{ banner:"Ansichtsmodus. Nur {name} kann Aenderungen machen.",
      want:"Will ich", thinking:"Ueberlege", bought:"Gekauft", empty:"In diesem Bereich ist nichts.",
      chipChanged:"umentschieden ×{n}", chipDays:{one:"in {n} Tag",other:"in {n} Tagen"}, chipLink:"Link",
      note:"Warum ich es will", openLink:"Link oeffnen", histTitle:"Wunschverlauf",
      hist:{ created:"Hinzugefuegt", changed_mind:"Umentschieden", purchased:"Gekauft", back_to_want:"Wieder gewuenscht", edited:"Bearbeitet" },
      cnt:{ changed:"umentschieden", bought:"gekauft", returned:"zurueckgelegt" },
      ro:"Nur Ansicht — {name} bearbeitet", close:"Schliessen", fullPhoto:"Foto voll oeffnen" },
    mood:{ happy:"Froh", mid:"So lala", sad:"Traurig" },
    acct:"Anmeldung",
    ev:{
      accounts:{ login:"In der App angemeldet" },
      wishlist:{ created:"Wunsch hinzugefuegt: “{t}”", changed_mind:"Umentschieden: “{t}”", purchased:"“{t}” — gekauft! 🎉",
        back_to_want:"Will “{t}” wieder", edited:"Wunsch “{t}” bearbeitet", favorite:"★ “{t}” markiert",
        unfavorite:"★ “{t}” entfernt", deleted:"Wunsch “{t}” entfernt", restored:"“{t}” zurueckgeholt", undo:"Aktion rueckgaengig gemacht",
        share_request:"Bat um Erlaubnis zum Teilen der Wunschliste 📨", share_grant:"Wunschliste mit “{t}” geteilt",
        share_revoke:"Wunschlisten-Zugriff von “{t}” entfernt",
        share_enabled:"Elternteil {n} hat die oeffentliche Wunschliste aktiviert 🌐", share_disabled:"Elternteil {n} hat die oeffentliche Wunschliste deaktiviert 🔒" },
      teeth:{ done:"Zaehne geputzt · +10", skipped:"Putzen uebersprungen", started:"Zaehneputzen gestartet" },
      rating:{ day_rated:"Tag bewertet: {stars}" },
      mood:{ mood_set:"Stimmung des Tages: {e} {name}" },
      reverse:{ created:"Ein Wort umgedreht" },
      guess:{ win:"Zahl erraten: richtig! +10", wrong:"Zahl erraten: falsch −5", timeout:"Zahl erraten: Zeit vorbei −5" },
      seabattle:{ win:"Schiffe versenken: Roboter besiegt! +10", loss:"Schiffe versenken: gegen Roboter verloren −5",
        famWin:"Schiffe versenken: Familienmatch gewonnen! 🏆 +10", famLoss:"Schiffe versenken: Familienmatch verloren",
        hot:"Schiffe versenken: Spiel zu zweit gespielt" },
      generic:{ created:"Eintrag hinzugefuegt", edited:"Eintrag bearbeitet", moved:"Eintrag verschoben", favorite:"Favorit markiert",
        unfavorite:"Favorit entfernt", deleted:"Eintrag entfernt", restored:"Eintrag wiederhergestellt", undo:"Aktion rueckgaengig gemacht" }
    }
  }}
  });
  ...
  function wire(root){
    ...
    var ot=root.querySelector("#pdOpenTasks"); if(ot) ot.onclick=function(){ if(RT.open){ RT._pendingLink={module:"bank",view:"assignments"}; RT.open("bank"); } };

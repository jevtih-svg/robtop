...
(function(){
  ...
  var MESSAGES={
    ...
    de:{ wishlist:{
      title:"Wunschliste", subtitle:"Meine Wunschliste",
      hud:{ cLbl:"Wuensche", rLbl:"gekauft" },
      tab:{ want:"Will ich", thinking:"Ueberlege", bought:"Gekauft" },
      empty:{ want:{h:"Noch leer",p:"Tippe unten auf “Will ich!” und fuege deinen ersten Wunsch hinzu."},
        thinking:{h:"Bereich “Ueberlege”",p:"Hier landen Wuensche, bei denen du unsicher bist. Tippe auf einer Karte “Umentschieden”."},
        bought:{h:"Bereich “Gekauft”",p:"Gekaufte Wuensche landen hier. Tippe auf einer Karte “Gekauft”."} },
      hist:{ created:"Hinzugefuegt", changed_mind:"Umentschieden", purchased:"Gekauft", back_to_want:"Wieder gewuenscht", edited:"Bearbeitet" },
      btn:{ bought:"Gekauft", thinking:"Umentschieden", want:"Will ich!", backWant:"Wieder wollen" },
      chip:{ changedMind:"umentschieden ×{n}", purchased:"gekauft ×{n}", days:{one:"in {n} Tag", other:"in {n} Tagen"} },
      aria:{ fav:"Will ich sehr", stats:"Statistik" },
      badge:{ bought:"Gekauft" }, link:{ open:"Link oeffnen" },
      detail:{ changedMind:"mal umentschieden", purchased:"mal gekauft", returned:"mal zurueckgelegt", edited:"mal bearbeitet",
        note:"Warum ich es will", favOn:"Will ich sehr", favOff:"Markieren", edit:"Bearbeiten", historyTitle:"Wunschverlauf" },
      purchase:{ q:"Wirklich gekauft?", qAgain:"Kauf nochmal bestaetigen", no:"Noch nicht", yes:"Ja, gekauft! 🎉", yesAgain:"Sicher? Nochmal tippen ✅" },
      stats:{ title:"Wunsch-Statistik", total:"Wuensche gesamt", boughtNow:"jetzt erfuellt", purchases:"Kaeufe gesamt",
        changedMind:"mal umentschieden", favorites:"★ will ich sehr", avgDays:"Durchschn. Tage bis Kauf",
        fickle:"Unentschlossenster Wunsch: <b>{name}</b> (umentschieden ×{n})" },
      form:{ newWish:"Neuer Wunsch", editWish:"Wunsch bearbeiten", addPhoto:"Foto hinzufuegen", replacePhoto:"Foto ersetzen",
        titleLabel:"Titel", titlePh:"z.B. LEGO-Set", noteLabel:"Warum willst du es?", optional:"(optional)",
        notePh:"z.B. Ich baue Roboter", linkLabel:"Link" },
      toast:{ saved:"Gespeichert", needTitle:"Gib einen Wunschtitel ein", added:"Wunsch hinzugefuegt! 🍒", addFailed:"Konnte nicht hinzugefuegt werden",
        addFailedOffline:"Konnte nicht hinzugefuegt werden (offline)", movedThinking:"Zu “Ueberlege” verschoben", movedWant:"Zurueck zu “Will ich”!",
        deleted:"Wunsch geloescht", congrats:"Glueckwunsch! Wunsch erfuellt 🎉", photoFailed:"Foto konnte nicht hochgeladen werden",
        photoFailedOffline:"Foto konnte nicht hochgeladen werden (offline)", noServer:"Keine Serververbindung — Aenderung nicht gespeichert",
        demoMode:"Demo-Modus: Server nicht verfuegbar" },
      seed:{ lego:{title:"LEGO Technic Set",note:"Ich baue Roboter und Autos"}, scooter:{title:"Stunt-Scooter"},
        book:{title:"Dinosaurier-Buch"}, headphones:{title:"Kabellose Kopfhoerer",note:"Draussen Musik hoeren"}, ball:{title:"Fussball"} },
      share:{ aria:"Wunschliste teilen", ariaFriends:"Wunschlisten von Freunden",
        shTitle:"Wunschliste teilen", frTitle:"Wunschlisten von Freunden",
        frEmpty:"Noch niemand hat eine Wunschliste mit dir geteilt.",
        linkHint:"Jeder mit diesem Link kann deine Wunschliste sehen:",
        copy:"Link kopieren", copied:"Kopiert",
        grantTitle:"Wer darf sie sehen", grantPh:"Nickname des Freundes", grantBtn:"Teilen",
        grantEmpty:"Du hast noch mit niemandem geteilt.", granted:"Jetzt kann {name} deine Wunschliste sehen!",
        revoke:"Zugriff entfernen", revoked:"Zugriff entfernt",
        askText:"Zum Teilen brauchst du die Erlaubnis deines Elternteils {name}. Anfrage senden?",
        askBtn:"Elternteil fragen", askSent:"Anfrage an deinen Elternteil gesendet 📨", askToo:"Du hast gerade schon gefragt — warte kurz",
        noParentText:"Du hast in der App noch keinen Elternteil. Lade ihn in den Einstellungen ein — Teilen geht nur mit Erlaubnis.",
        openSettings:"Einstellungen oeffnen", demoOnly:"Funktioniert nur auf dem Server",
        errUser:"Nutzer nicht gefunden", errGrant:"Mit diesem Nutzer kannst du nicht teilen", loadFail:"Konnte nicht geladen werden" }
    }}
  };

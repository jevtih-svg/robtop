...
return [
    ...
    'parent_attached' => [
        'desc'         => 'Админ привязал СУЩЕСТВУЮЩЕГО родителя к семье: уведомление (вход обычным паролем, без временного).',
    ...
    'admin_invite_parent' => [
        'desc'         => 'Админ создал родительский аккаунт: приглашение в приложение (что это, зачем присоединяться, вход по email + одноразовый временный пароль).',
        'file'         => 'admin_invite_parent',
        'placeholders' => ['{{nickname}}', '{{link}}', '{{temp_password}}'],
        'subject'      => [

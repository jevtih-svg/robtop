...
(function(){
  ...
  var MESSAGES={
    ...
    de:{ teeth:{
      title:"Zaehneputz-Timer", subtitle:"2 Minuten putzen — Punkte verdienen",
      idleMinutes:"2 Minuten putzen", start:"Putzen starten", runningState:"Zaehne putzen…",
      skipAria:"Anderer Track", cancel:"Abbrechen",
      infoReward:"Belohnung: <b>+10</b>", infoStreak:"Serie: <b>{n}</b> {days}", infoPoints:"Punkte: <b>{n}</b>",
      hudLeft:"🦷 <b>Zaehne</b>", hudCLbl:"Serie", hudRLbl:"Punkte",
      days:{ one:"Tag", other:"Tage" },
      tabHistory:"Verlauf", tabMusic:"Musik",
      filterAll:"Alle", filterDone:"Fertig", filterSkipped:"Uebersprungen",
      statusDone:"Fertig", statusSkip:"Uebersprungen",
      histEmptyDone:"Noch keine fertigen Putzrunden. Lass den Timer bis zum Ende laufen — dann erscheint sie hier.",
      histEmptySkipped:"Keine uebersprungenen Putzrunden. Weiter so! 💪",
      histEmptyAll:"Noch keine Putzrunden. Tippe “Putzen starten”.",
      musicHintRunning:"Putzen laeuft. Tippe auf einen Track, um die Musik sofort zu wechseln.",
      musicHintShuffle:"Zufallswiedergabe ist an. Auswaehlen markiert einen Track, aber gespielt wird weiter zufaellig.",
      musicHintNormal:"Waehle einen Track — er spielt beim naechsten Putzen. ▶ zum Reinhören.",
      track:"Track {n}", noteLive:" · laeuft jetzt", noteNext:" · spielt als naechstes",
      pickedShuffle:"Track markiert: {name} (Zufall ausmachen, damit er spielt)",
      pickedNext:"Spielt als naechstes: {name}",
      ariaPause:"Pause", ariaLive:"Laeuft jetzt", ariaListen:"Anhoeren", ariaPick:"Waehlen",
      toastFinish:"Super! Putzen fertig 🎉", toastCancel:"Putzen gestoppt — keine Punkte",
      toastPlayHint:"Tippe nochmal auf “Putzen starten”, um Musik einzuschalten",
      toastPreviewHint:"Tippe nochmal zum Anhoeren",
      loadError:"Daten konnten nicht geladen werden. Versuch es spaeter.",
      remindMorning:"Zeit zum Zaehneputzen!", remindEvening:"Vergiss das abendliche Zaehneputzen nicht.",
      remindUnsupported:"Benachrichtigungen werden nicht unterstuetzt", remindEnabled:"Erinnerungen aktiviert", remindDenied:"Benachrichtigungen sind im Browser blockiert",
      parentTitle:"Fuer Eltern", parentOnly:"Nur fuer angemeldete Eltern.",
      parentDone:"fertig", parentSkipped:"uebersprungen", parentPoints:"Punkte",
      secManualPoints:"Punkte manuell", secMusicReward:"Musik-Belohnung", shuffleLabel:"Tracks mischen",
      secReminders:"Erinnerungen", morning:"Morgen", evening:"Abend", enableReminders:"Erinnerungen aktivieren",
      parentNote:"Die Erinnerung erscheint, solange die App offen ist. Fuer Hintergrundmeldungen fuege die App zum Home-Bildschirm hinzu.",
      shuffleOn:"Zufall an", shuffleOff:"Tracks der Reihe nach",
      lockClosedTitle:"Keine Putzzeit", lockClosedText:"Wir putzen morgens von 5:00 bis 10:00 und abends von 18:00 bis 23:59.",
      lockDoneTitle:"Schon erledigt ✓", lockDoneText:"Gut gemacht! Punkte wurden vergeben. Einmal pro Tageszeit putzen.",
      lockNextIn:"Naechstes Putzen in {time}", unitH:"Std.", unitM:"Min."
    }}
  };
